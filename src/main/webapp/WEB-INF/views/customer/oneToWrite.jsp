      ...
      <div class="w-100 d-flex flex-column justify-content-between align-items-center mx-0 my-3 border p-3">
        <form action="oneToAction" method="get" class="w-100">
          ...
          <div class="w-100 d-flex justify-content-center">
            ...
            <a href="../customer/oneToOne" class="btn btn-primary col-3 mt-4 mb-2">취소</a>
          </div>
        </form>
      </div>     
    <!-- Content div 종료 -->
