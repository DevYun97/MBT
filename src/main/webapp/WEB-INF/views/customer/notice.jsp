  ...
  <body>
    ...
    <div class="container-sm container-fluid d-flex flex-column align-items-center justify-content-center border mx-auto" style="max-width: 520px;">
      ...
      <div class="w-100 d-flex justify-content-between align-items-center mx-0 mt-3 border p-2" style="height: 56px;">
        ...
        <!-- 관리자용 -->
        <div>          
          <a href="/customer/noticeWrite.html" class="btn btn-primary" style="height: 30px; font-size: 14px;">글작성</a>
        </div>
      </div>
      <div class="w-100 d-flex flex-column justify-content-between align-items-center mx-0 my-3 border p-3">
        <!-- 공지사항 불러오기 -->
        <a href="../customer/noticeDetail" class="w-100 d-flex justify-content-between align-items-center mt-3 pb-3 border-bottom text-body">
          <div>공지사항제목</div>
          <div class="text-right text-muted" style="font-size:12px;">2022.03.00<i class="bi bi-chevron-right"></i></div>
        </a>
        <a href="../customer/noticeDetail" class="w-100 d-flex justify-content-between align-items-center mt-3 pb-3 border-bottom text-body">
          <div>공지사항제목</div>
          <div class="text-right text-muted" style="font-size:12px;">2022.03.00<i class="bi bi-chevron-right"></i></div>
